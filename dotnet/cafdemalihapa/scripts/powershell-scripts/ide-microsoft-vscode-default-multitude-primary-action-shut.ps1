<#> fina = file name = ide-microsoft-vscode-default-multitude-primary-action-shut.ps1 #>

get-content "ide-microsoft-vscode-default-multitude-primary-action-shut.env" | ForEach-Object {
    $name, $value = $_.split("=")
