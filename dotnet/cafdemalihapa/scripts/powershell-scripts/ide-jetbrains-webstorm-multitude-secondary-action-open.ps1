<#> fina = file name = ide-jetbrains-webstorm-multitude-secondary-action-open.ps1 #>

get-content "ide-jetbrains-webstorm-multitude-secondary-action-open.env" | ForEach-Object {
    $name, $value = $_.split("=")
