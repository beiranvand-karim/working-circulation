                ...
                try
                {
                    ...
                    var contentToWrite = destFileName switch
                    {
                        ...
                        "ide-jetbrains-rider-multitude-secondary-action-shut.env" => ideJetbrainsRiderMultitudeSecondaryActionShut.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-default-multitude-primary-action-open.env" => ideMicrosoftVscodeDefaultMultitudePrimaryActionOpen.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-default-multitude-secondary-action-open.env" => ideMicrosoftVscodeDefaultMultitudeSecondaryActionOpen.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-default-multitude-primary-action-shut.env" => ideMicrosoftVscodeDefaultMultitudePrimaryActionShut.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-default-multitude-secondary-action-shut.env" => ideMicrosoftVscodeDefaultMultitudeSecondaryActionShut.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-insiders-multitude-primary-action-open.env" => ideMicrosoftVscodeInsidersMultitudePrimaryActionOpen.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-insiders-multitude-secondary-action-open.env" => ideMicrosoftVscodeInsidersMultitudeSecondaryActionOpen.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-insiders-multitude-primary-action-shut.env" => ideMicrosoftVscodeInsidersMultitudePrimaryActionShut.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
                        "ide-microsoft-vscode-insiders-multitude-secondary-action-shut.env" => ideMicrosoftVscodeInsidersMultitudeSecondaryActionShut.PairUpVariablesWithTheirValue(templateFile,
                            environmentVariablesSourceDictionary),
