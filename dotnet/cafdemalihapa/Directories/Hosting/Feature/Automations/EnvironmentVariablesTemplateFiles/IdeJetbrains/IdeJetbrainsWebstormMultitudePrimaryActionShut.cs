...
namespace cafdemalihapa.Directories.Hosting.Feature.Automations.EnvironmentVariablesTemplateFiles.IdeJetbrains
{
    public class IdeJetbrainsWebstormMultitudePrimaryActionShut(
        ...
        ILogger<IdeJetbrainsWebstormMultitudePrimaryActionShut> logger
    )
    {
        ...
        )
        {
            ...
            while (streamReader.ReadLine() is { } line)
            {
                ...
                {
                    logger.LogError("IdeJetbrainsWebstormMultitudePrimaryActionShut: the key could not be processed: {Key}", key);
                }
            }
