...
namespace cafdemalihapa.Directories.Hosting.Feature.Automations.EnvironmentVariablesTemplateFiles.IdeJetbrains
{
    public class IdeJetbrainsRiderMultitudePrimaryActionOpen(
        FeatureName featureName,
        SecondaryApplication secondaryApplication,
        PrimaryApplication primaryApplication,
        HostingDirectory hostingDirectory,
        StringHelpers stringHelpers,
        ILogger<IdeJetbrainsRiderMultitudePrimaryActionOpen> logger
    )
    {
