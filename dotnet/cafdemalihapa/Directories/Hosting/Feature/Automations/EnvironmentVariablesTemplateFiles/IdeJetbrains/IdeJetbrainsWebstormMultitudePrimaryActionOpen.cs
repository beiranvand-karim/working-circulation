...
namespace cafdemalihapa.Directories.Hosting.Feature.Automations.EnvironmentVariablesTemplateFiles.IdeJetbrains
{
    public class IdeJetbrainsWebstormMultitudePrimaryActionOpen(
        ...
        ILogger<IdeJetbrainsWebstormMultitudePrimaryActionOpen> logger
    )
    {
        ...
        )
        {
            ...
            while (streamReader.ReadLine() is { } line)
            {
                ...
                {
                    logger.LogError("IdeJetbrainsWebstormMultitudePrimaryActionOpen: the key could not be processed: {Key}", key);
                }
            }
