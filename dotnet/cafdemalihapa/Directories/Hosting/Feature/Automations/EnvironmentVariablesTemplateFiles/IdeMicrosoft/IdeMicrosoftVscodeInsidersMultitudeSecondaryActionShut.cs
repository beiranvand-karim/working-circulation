...
{
    public class IdeMicrosoftVscodeInsidersMultitudeSecondaryActionShut(
        FeatureName featureName,
        SecondaryApplication secondaryApplication,
        StringHelpers stringHelpers,
        ILogger<IdeMicrosoftVscodeInsidersMultitudeSecondaryActionShut> logger
    )
    {
        ...
        )
        {
            ...
            while (streamReader.ReadLine() is { } line)
            {
                ...
                {
                    logger.LogError("IdeMicrosoftVscodeInsidersMultitudeSecondaryActionShut: the key could not be processed: {Key}", key);
                }
            }
