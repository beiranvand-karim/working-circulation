...
{
    public class IdeMicrosoftVscodeInsidersMultitudePrimaryActionShut(
        FeatureName featureName,
        PrimaryApplication primaryApplication,
        StringHelpers stringHelpers,
        ILogger<IdeMicrosoftVscodeInsidersMultitudePrimaryActionShut> logger
    )
    {
        ...
        )
        {
            ...
            while (streamReader.ReadLine() is { } line)
            {
                ...
                {
                    logger.LogError("IdeMicrosoftVscodeInsidersMultitudePrimaryActionShut: the key could not be processed: {Key}", key);
                }
            }
