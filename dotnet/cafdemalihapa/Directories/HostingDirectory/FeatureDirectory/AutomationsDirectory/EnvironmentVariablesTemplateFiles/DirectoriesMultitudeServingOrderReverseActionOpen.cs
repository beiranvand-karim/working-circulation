...
{
    public class DirectoriesMultitudeServingOrderReverseActionOpen
    (
        ...
        CodeBase codeBase,
        ILogger<DirectoriesMultitudeServingOrderReverseActionOpen> logger
    )
    {
        ...
        )
        {
            ...
            while (streamReader.ReadLine() is { } line)
            {
                ...
                if (environmentVariablesSourceDictionary.TryGetValue(key, out var val))
                {
                    ...
                    {
                        logger.LogError("DirectoriesMultitudeServingOrderReverseActionOpen: the key could not be processed: {Key}", key);
                    }
                }
            }
