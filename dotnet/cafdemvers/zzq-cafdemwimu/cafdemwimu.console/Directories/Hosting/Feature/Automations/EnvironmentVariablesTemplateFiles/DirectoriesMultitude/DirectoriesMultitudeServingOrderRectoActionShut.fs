...
type DirectoriesMultitudeServingOrderRectoActionShut
    (
        ...
        logger: ILogger<DirectoriesMultitudeServingOrderRectoActionShut>
    ) =
        ...
        while not (isNull line) do
            ...
            | true, valFromSource ->
                try
                    ...
                    | _ -> ()
                with _ ->
                    logger.LogError("DirectoriesMultitudeServingOrderRectoActionShut: the key could not be processed: {Key}", key)
            | _ -> ()
