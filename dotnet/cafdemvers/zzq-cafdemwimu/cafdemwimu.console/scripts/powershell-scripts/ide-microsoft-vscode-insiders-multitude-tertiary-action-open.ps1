<#> fina = file name = ide-microsoft-vscode-insiders-multitude-tertiary-action-open.ps1 #>

get-content "ide-microsoft-vscode-insiders-multitude-tertiary-action-open.env" | ForEach-Object {
    $name, $value = $_.split("=")
