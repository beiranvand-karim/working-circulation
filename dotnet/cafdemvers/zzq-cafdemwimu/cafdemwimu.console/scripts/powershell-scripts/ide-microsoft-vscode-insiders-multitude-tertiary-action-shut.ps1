<#> fina = file name = ide-microsoft-vscode-insiders-multitude-tertiary-action-shut.ps1 #>

get-content "ide-microsoft-vscode-insiders-multitude-tertiary-action-shut.env" | ForEach-Object {
    $name, $value = $_.split("=")
