<#> fina = file name = ide-jetbrains-webstorm-multitude-tertiary-action-open.ps1 #>

get-content "ide-jetbrains-webstorm-multitude-tertiary-action-open.env" | ForEach-Object {
    $name, $value = $_.split("=")
...
$ArgumentList =(
    ...
    " --application-location $env:TERTIARY_CLIENTAPP_LOCATION" +
