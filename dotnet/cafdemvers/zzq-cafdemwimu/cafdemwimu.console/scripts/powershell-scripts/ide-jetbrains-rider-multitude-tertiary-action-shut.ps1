<#> fina = file name = ide-jetbrains-rider-multitude-tertiary-action-shut.ps1 #>

get-content "ide-jetbrains-rider-multitude-tertiary-action-shut.env" | ForEach-Object {
    $name, $value = $_.split("=")
