<#> fina = file name = ide-microsoft-vscode-insiders-multitude-secondary-action-shut.ps1 #>

get-content "ide-microsoft-vscode-insiders-multitude-secondary-action-shut.env" | ForEach-Object {
    $name, $value = $_.split("=")
