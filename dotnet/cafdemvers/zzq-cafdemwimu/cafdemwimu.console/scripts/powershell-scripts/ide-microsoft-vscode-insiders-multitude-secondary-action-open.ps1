<#> fina = file name = ide-microsoft-vscode-insiders-multitude-secondary-action-open.ps1 #>

get-content "ide-microsoft-vscode-insiders-multitude-secondary-action-open.env" | ForEach-Object {
    $name, $value = $_.split("=")
