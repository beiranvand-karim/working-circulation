<#> fina = file name = ide-microsoft-vscode-insiders-multitude-primary-action-open.ps1 #>

get-content "ide-microsoft-vscode-insiders-multitude-primary-action-open.env" | ForEach-Object {
    $name, $value = $_.split("=")
