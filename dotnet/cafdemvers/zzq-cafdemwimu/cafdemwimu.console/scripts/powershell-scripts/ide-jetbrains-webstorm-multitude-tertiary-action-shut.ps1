<#> fina = file name = ide-jetbrains-webstorm-multitude-tertiary-action-shut.ps1 #>

get-content "ide-jetbrains-webstorm-multitude-tertiary-action-shut.env" | ForEach-Object {
    $name, $value = $_.split("=")
