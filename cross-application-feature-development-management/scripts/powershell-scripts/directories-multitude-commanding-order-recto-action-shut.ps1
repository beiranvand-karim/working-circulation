...
$directories_collection = @($feature_self_address, $operations_directory_path, $fend_address, $fend_host_address, $fend_guest_address , $bend_address , $calls_address , $tools_address, $notes_messages_address , $web_links_address);
