<#> fina = file name = ide-jetbrains-rider-multitude-secondary-action-shut.ps1 #>

get-content "ide-jetbrains-rider-multitude-secondary-action-shut.env" | ForEach-Object {
    $name, $value = $_.split("=")
