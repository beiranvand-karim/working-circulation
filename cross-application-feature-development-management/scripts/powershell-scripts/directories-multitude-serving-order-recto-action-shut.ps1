<#> fina = file name = directories-multitude-serving-order-recto-action-shut.ps1 #>

get-content "directories-multitude-serving-order-recto-action-shut.env" | ForEach-Object {
    $name, $value = $_.split("=")
