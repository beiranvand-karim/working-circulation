<#> fina = file name = docker-network-secondary-multitude-primary-action-stop.ps1 #>

get-content "docker-network-secondary-multitude-primary-action-stop.env" | ForEach-Object {
    $name, $value = $_.split("=")
