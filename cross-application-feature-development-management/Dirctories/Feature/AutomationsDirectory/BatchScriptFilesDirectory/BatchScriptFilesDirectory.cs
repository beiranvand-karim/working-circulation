...
namespace cross_application_feature_development_management.Dirctories.Feature.AutomationsDirectory.BatchScriptFilesDirectory
{
    ...
    public class BatchScriptFilesDirectory(
            ...
            INotepadPlusPlusMultitudeAllOrderReverse notepadPlusPlusMultitudeAllOrderReverse
        ) : IBatchScriptFilesDirectory
    {
        ...
        private readonly INotepadPlusPlusMultitudeAllOrderReverse notepadPlusPlusMultitudeAllOrderReverse = notepadPlusPlusMultitudeAllOrderReverse;
        ...
        public void Populate(string destinationDirectory, string templateSourceDirectory, Dictionary<string, string> environmentVariablesSourceDictionary)
        {
            foreach (string templateFile in Directory.EnumerateFiles(templateSourceDirectory))
            {
                ...
                else if (templateFile.Contains("notepadplusplus-multitude-all-order-reverse"))
                {
                    contentToWrite =
                    notepadPlusPlusMultitudeAllOrderReverse.PairUpVariablesWithTheirValue(templateFile, environmentVariablesSourceDictionary);
                }
