...
static Dictionary<string, string> PairUpVariablesWithTheirValue(string fileNamePath, Dictionary<string, string> environmentVariablesSourceDictionary) {
        ...
        while ((line = streamReader.ReadLine()) != null) 
        {
            ...
            Console.WriteLine(" dfkshfsf , ${0}  ,   ${1}",  key,  val);
        }
...
if (choice == 2) 
{
    ...
    foreach (string file in Directory.EnumerateFiles(sourceDirectory))  
    {
        ...
        Dictionary<string, string>  contentToWrite  =  PairUpVariablesWithTheirValue(file, environmentVariablesSourceDictionary);
    }
}
